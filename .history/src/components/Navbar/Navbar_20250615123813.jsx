...
const Navbar = () => {
  ...
  <span className="ml-2 text-2xl font-bold hidden sm:inline-block">
    <span className="text-amber-600 group-hover:text-amber-700 transition-colors">Share</span>
    <span className="text-orange-500 group-hover:text-orange-600 transition-colors">Bite</span>
  </span>
</NavLink>
            </div>
