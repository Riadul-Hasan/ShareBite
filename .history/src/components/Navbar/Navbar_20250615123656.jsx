...
const Navbar = () => {
  ...
  {/* Food icon - can replace with your own */}
  <svg 
  ...
  <span className="ml-2 text-2xl font-bold hidden sm:inline-block bg-gradient-to-r from-amber-600 to-orange-600 bg-clip-text text-transparent group-hover:from-amber-700 group-hover:to-orange-700 transition-all">
    Share Bite
    <span className="text-sm font-normal ml-1 text-amber-500">™</span>
  </span>
</NavLink>
            </div>
