...
const Additional2 = () => {
    ...
    Join our movement to rescue good food from going to waste. Connect with your community through the simple act of sharing what you have.
                    ...
                    <div className='flex justify-around w-auto lg:w-3/5 mx-auto space-x-2'>
                        <button className="btn bg-gradient-to-r from-green-500  to-green-300 text-gray-600 border-none ">Explore</button>
