...
const SingUp = () => {
    ...
    return (
        <motion.div
            ...
            className="min-h-[calc(100vh-320px)] bg-gradient-to-br from-amber-50 via-orange-50 to-rose-100 flex items-center justify-center px-4 py-8"
        >
            ...
            >
                ...
                <motion.div
                    ...
                    className="w-full md:w-2/5 bg-gradient-to-br from-amber-400 to-orange-500 p-8 flex flex-col justify-center"
                >
                    <div className="text-center">
                        <motion.div
                            whileHover={{ rotate: 15 }}
                            className="bg-white p-4 rounded-full shadow-lg w-20 h-20 flex items-center justify-center mx-auto mb-6"
                        >
                            <GiCook className="text-amber-600 text-3xl" />
                        </motion.div>
                        <motion.h2
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
                ...
                >
                    ...
                    >
                        <motion.button
                            ...
                            whileTap={{ scale: 0.98 }}
                            className="w-full flex items-center justify-center gap-2 py-2 px-4 rounded-lg font-medium text-gray-700 bg-white border border-gray-200 hover:bg-gray-50 shadow-sm"
                        >
